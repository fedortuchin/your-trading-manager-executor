...
IMAGE="ghcr.io/fedortuchin/your-trading-manager-executor:v0.5.0"
SERVER_URL=""
ENROLLMENT_TOKEN=""
BROKER_PROVIDER=""
...
Options:
  ...
  --image <image>                    Default: ghcr.io/fedortuchin/your-trading-manager-executor:v0.5.0.
  --install-dir <path>               Default: /opt/ytm-executor.
  --no-start                         Install and enroll, but do not start the compose service.
  -h, --help                         Show this help.

Example:
  curl -fsSL https://raw.githubusercontent.com/fedortuchin/your-trading-manager-executor/v0.5.0/scripts/install.sh | sudo bash -s -- \
